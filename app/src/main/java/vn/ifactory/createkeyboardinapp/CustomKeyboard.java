...
public class CustomKeyboard{
    ...
    private KeyboardView.OnKeyboardActionListener mOnKeyboardActionListener = new KeyboardView.OnKeyboardActionListener() {
        ...
        public void onKey(int primaryCode, int[] keyCodes) {
            ...
            } else if (focusCurrent.getClass() == AppCompatEditText.class) {
    ...
    private <T> void checkKeyCodeEdittext(T edittext) {
    ...
    public CustomKeyboard(Activity host, int viewid, int layoutid) {
        ...
        //mHostActivity.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE|WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
